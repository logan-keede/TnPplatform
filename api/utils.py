...
def generate_pdf(data, output_file):
    ...
    # file_path = finders.find('fonts/cmr12.ttf')
    # if file_path:
    ...
    # font_path = os.path.join(static('./fonts'), 'cmr12.ttf')
    # pdf.add_font('cmr', '', font_path, uni=True)
    ...
    # for file in files:
    #     print(file.name)
    # pdf.add_font('cmr', '', '\\static\\fonts\\cmr12.ttf')
    # pdf.add_font('cmr', '', static('./fonts/cmr12.ttf'))
    # pdf.add_font('cmbx','', static('./fonts/cmbx12.ttf'))
    # pdf.add_font('cmsl','', static('./fonts/cmsl12.ttf'))

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "Student_ID",
                    models.CharField(default="studentID", max_length=20, unique=True),
                ),
                (
                    "Branch",
                    models.CharField(
                        choices=[("CSE", "CSE"), ("ECE", "ECE")], max_length=50
                    ),
                ),
                ("Resume_Link", models.CharField(default="blank", max_length=300)),
                (
                    "CGPA",
                    models.DecimalField(decimal_places=2, default="5.00", max_digits=3),
                ),
